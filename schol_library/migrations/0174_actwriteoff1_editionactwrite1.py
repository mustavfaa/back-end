...
class Migration(migrations.Migration):
    ...
    dependencies = [
     ...
     #   ('portfoli', '0113_auto_20200527_0751'),
        ('schol_library', '0173_booksrecall_order'),
    ]
    ...
    operations = [
        ...
        #         ('invoice', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='editions_invoice', to='schol_library.ActWriteOff1', verbose_name='Акт на списание')),
        #     ],
        #     options={
