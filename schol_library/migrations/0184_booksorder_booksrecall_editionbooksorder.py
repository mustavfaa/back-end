# Generated by Django 2.2 on 2020-05-29 01:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
      #  ('portfoli', '0114_auto_20200529_0749'),
        ...
        ('schol_library', '0183_auto_20200529_0749'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='editions_invoice', to='schol_library.BooksOrder', verbose_name='Заявка на книги')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quanity_after_recall', models.IntegerField(blank=True, default=0)),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('edition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='schol_library.Edition')),
                ('order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='schol_library.BooksOrder')),
