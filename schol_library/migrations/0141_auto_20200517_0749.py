# Generated by Django 2.2 on 2020-05-17 01:49
...
def add_initial_balance(apps, sch_editor):
    ...
    schs = NumberBooks.objects.filter(deleted=False).exclude(edition=None).exclude(school=None).values_list('school',
                                                                                                            flat=True).distinct()
...
class Migration(migrations.Migration):
    dependencies = [
        ('schol_library', '0140_auto_20200517_0742'),
    ]
